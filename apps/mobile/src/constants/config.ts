...
export const config = {
  // API Configuration
  API_BASE_URL: Constants.expoConfig?.extra?.apiBaseUrl || 'https://bridgea-l8065mqdi-alejandros-projects-75565a5d.vercel.app/api',
  SOCKET_URL: Constants.expoConfig?.extra?.socketUrl || 'https://bridgea-l8065mqdi-alejandros-projects-75565a5d.vercel.app',
