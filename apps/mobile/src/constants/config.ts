...
export const config = {
  // API Configuration
  API_BASE_URL: Constants.expoConfig?.extra?.apiBaseUrl || 'https://bridgea-mhv7n2ni0-alejandros-projects-75565a5d.vercel.app/api',
  SOCKET_URL: Constants.expoConfig?.extra?.socketUrl || 'https://bridgea-mhv7n2ni0-alejandros-projects-75565a5d.vercel.app',
